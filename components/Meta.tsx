...
const Meta: React.VFC<MetaProps> = (props) => {
    ...
    const description = `Hi, I am a 5 years experienced full stack developer with skills with React, NodeJS, Laravel, MySQL, MongoDB. Contact me for further information`
    ...
    return (
        <Head>
            ...
            <meta
                property="og:image"
                content="https://mauriziocarella.it/images/header.png"
            />
